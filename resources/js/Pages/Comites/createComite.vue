...
const form = useForm({
    id: props.comite.id, nombre: props.comite.nombre, codigo: props.comite.codigo, descripcion: props.descripcion, estado: props.estado, usuario_id: props.usuario_id
});

const save = () => {
    form.post(route('comites.store'), {
        onSuccess: (response) => {
            mensaje();
        }
    });
